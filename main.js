...
async function convolveInstrument(instrument, angle, useStereoPair = false){
    ...
    let instrumentPathStart = 'https://hytheaway.github.io/aftw/ggm-scnbrmwaa/audio/';
    let instrumentPathEnd = '.wav';
    let leftIRPathStart = 'https://hytheaway.github.io/aftw/ggm-scnbrmwaa/audio/impulse_responses/MIT/L0e';
    let rightIRPathStart = 'https://hytheaway.github.io/aftw/ggm-scnbrmwaa/audio/impulse_responses/MIT/R0e';
    let stereoIRPathStart = 'https://hytheaway.github.io/aftw/ggm-scnbrmwaa/audio/impulse_responses/D1/'
    let IRPathEnd = 'a.wav';
